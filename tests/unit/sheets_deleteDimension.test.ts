...
describe('sheets_deleteDimension - Unit Tests', () => {
  describe('Schema Validation', () => {
    it('should validate correct parameters for deleting rows', () => {
      const validInput = {
      ...
      const result = SheetsDeleteDimensionSchema.safeParse(validInput);
    ...
    it('should validate correct parameters for deleting columns', () => {
      const validInput = {
        spreadsheetId: '1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms',
        sheetId: 123,
    ...
    it('should reject missing spreadsheetId', () => {
      ...
      const result = SheetsDeleteDimensionSchema.safeParse(invalidInput);
  ...
  describe('API Request Formation', () => {
    it('should form correct DeleteDimensionRequest for rows', () => {
      const input = {
        spreadsheetId: '1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms',
        sheetId: 0,
        dimension: 'ROWS' as const,
      ...
      expect(expectedRequest.requestBody.requests[0].deleteDimension.range.sheetId).toBe(input.sheetId);
      expect(expectedRequest.requestBody.requests[0].deleteDimension.range.dimension).toBe('ROWS');
      expect(expectedRequest.requestBody.requests[0].deleteDimension.range.startIndex).toBe(5);
      expect(expectedRequest.requestBody.requests[0].deleteDimension.range.endIndex).toBe(10);
    });

    it('should form correct DeleteDimensionRequest for columns', () => {
      const input = {
        spreadsheetId: '1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms',
        sheetId: 123,
        dimension: 'COLUMNS' as const,
      ...
      expect(expectedRequest.deleteDimension.range.dimension).toBe('COLUMNS');
      expect(expectedRequest.deleteDimension.range.sheetId).toBe(123);
    });
