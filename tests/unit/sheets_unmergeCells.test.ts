...
describe('sheets_unmergeCells - Unit Tests', () => {
  describe('Schema Validation', () => {
    it('should validate correct parameters', () => {
      ...
      const result = SheetsUnmergeCellsSchema.safeParse(validInput);
    ...
    it('should reject missing spreadsheetId', () => {
      ...
      const result = SheetsUnmergeCellsSchema.safeParse(invalidInput);
  ...
  describe('API Request Formation', () => {
    it('should form correct UnmergeCellsRequest', () => {
      const input = {
        spreadsheetId: '1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms',
        sheetId: 0,
        startRowIndex: 2,
      ...
      expect(expectedRequest.requestBody.requests[0].unmergeCells.range.sheetId).toBe(0);
      expect(expectedRequest.requestBody.requests[0].unmergeCells.range.startRowIndex).toBe(2);
      expect(expectedRequest.requestBody.requests[0].unmergeCells.range.endRowIndex).toBe(5);
    });
  });
});
